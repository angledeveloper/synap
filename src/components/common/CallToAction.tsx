    ...
    <div className="mt-16 bg-gradient-to-r from-[#1160C9] from-0% to-[#08D2B8] p-12">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between gap-6">
          ...
          <a 
            href={buttonLink}
            className="flex h-[105px] min-w-[300px] cursor-pointer flex-col items-start justify-between rounded-[10px] bg-black p-4 text-[20px] outline-white hover:opacity-85 hover:outline-2 max-md:w-full"
          >
