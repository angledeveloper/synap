  ...
  return (
    <div className="flex items-center gap-6">
      ...
      <Select value={value || options?.[0]} onValueChange={onChange}>
        <SelectTrigger className="w-[94px] h-[28px] text-[16px] font-normal text-black border-black rounded-none [&>svg]:!text-black [&>svg]:!opacity-100" style={{fontFamily: 'var(--font-space-grotesk), sans-serif'}}>
          <SelectValue />
        </SelectTrigger>
