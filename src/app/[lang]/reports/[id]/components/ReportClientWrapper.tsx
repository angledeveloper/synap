...
export default function ReportClientWrapper({ sections, children, reportData, lang, slug }: ReportClientWrapperProps) {
    ...
    useEffect(() => {
        if (reportData && lang && slug) {
            ...
            const languageId = codeToId[lang as keyof typeof codeToId] || codeToId['en'];
