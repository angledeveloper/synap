...
export default function GlobalFooter() {
  ...
  return (
    ...
    >
      <div className="m-auto flex w-full max-w-[1700px] flex-col gap-4 pt-10 md:flex-row">
        <div className="flex w-full flex-col justify-between gap-4 md:flex-row">
          <div className="w-full max-w-[500px]">
            <span className="text-[32px] font-bold md:text-[48px]">
              {HomePage.footer.section.title}
            </span>
            <p className="text-sm">{HomePage.footer.section.tagline}</p>
      ...
      <div className="m-auto my-10 w-full max-w-[1700px] text-[20px] text-[#808080]">
        {HomePage.footer.section.description}
      </div>
      <div className="m-auto my-10 w-full max-w-[1700px] text-[20px]">
        <div className="aspect-[990/157.59] max-h-[160px] w-full">
          <FullLogo />
        </div>
      </div>
      <div className="m-auto my-10 flex w-full max-w-[1700px] flex-col gap-4 text-[20px] text-[#808080] md:flex-row md:justify-between">
